...
vu16 dummy;
extern char  Show_Text[];//LCD显示缓存数组
...
{
    LCD_Clear(Blue);
	LCD_SetBackColor(Blue);//背景色
	LCD_SetTextColor(White);//前景色
	
	LCD_DisplayStringLine(Line0, (uint8_t *)"                    ");
	LCD_DisplayStringLine(Line1, (uint8_t *)"                    ");
	LCD_DisplayStringLine(Line2, (uint8_t *)"      Display       ");
	LCD_DisplayStringLine(Line3, (uint8_t *)"                    ");
	//LCD_DisplayStringLine(Line4, (uint8_t *)"Brightness:  0%     ");
	sprintf(Show_Text,"Brightness:%3d%% ",Pwm_PA6_duty/10);
	LCD_DisplayStringLine(Line4, (uint8_t *)Show_Text);
	
	LCD_DisplayStringLine(Line5, (uint8_t *)"                    ");
	LCD_DisplayStringLine(Line6, (uint8_t *)"Remaining time:     ");
	LCD_DisplayStringLine(Line7, (uint8_t *)"                    ");
	LCD_DisplayStringLine(Line8, (uint8_t *)"Remote Control:OFF  ");
	LCD_DisplayStringLine(Line9, (uint8_t *)"                    ");
}
extern bool time_on_off;
void LCD_Time_Show(int num)
{
	LCD_SetBackColor(Blue);//背景色
	LCD_SetTextColor(White);//前景色
	switch(num)
	{
		case 1:
			LCD_DisplayStringLine(Line0, (uint8_t *)"                    ");
			LCD_DisplayStringLine(Line1, (uint8_t *)"                    ");
			LCD_DisplayStringLine(Line2, (uint8_t *)"   Timer Setting    ");
			LCD_DisplayStringLine(Line3, (uint8_t *)"                    ");
		    LCD_DisplayStringLine(Line4, (uint8_t *)"Machine ON/OFF:     ");
		...
		case 2:
			...
			LCD_DisplayStringLine(Line2, (uint8_t *)"   Timer Setting    ");
			LCD_DisplayStringLine(Line3, (uint8_t *)"                    ");
		    LCD_DisplayStringLine(Line4, (uint8_t *)"Timer Start:00:00:00");
		...
		case 3:
			...
			LCD_DisplayStringLine(Line2, (uint8_t *)"   Timer Setting    ");
			LCD_DisplayStringLine(Line3, (uint8_t *)"                    ");
			LCD_DisplayStringLine(Line4, (uint8_t *)"Keep Time:          ");
